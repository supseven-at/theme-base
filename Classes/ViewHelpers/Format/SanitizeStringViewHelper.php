 ...
 *
 * This class extends AbstractViewHelper and provides methods to sanitize strings.
 *
 * EXAMPLE:
 *
 * <theme:format.sanitizeString string="string mit sonder und leerzeichen mit öÄüÖL??´´ und so weiter"></theme:format.sanitizeString>
 *
 * results in: string-mit-sonder-und-leerzeichen-mit-oeaeueoel-und-so-weiter
 *
 * can be used to generate css-ids or classnames and averywhere else where a clean name is needed
 */
